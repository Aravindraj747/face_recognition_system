...
#Download the images from the Internet and save the cropped images
...
validation_data = test_image_generator.flow_from_directory(batch_size = BATCH_SIZE, 
                                                          ...
                                                          shuffle = False, 
                                                          target_size = (image_size, image_size),
                                                          class_mode = 'binary')#Tensorlflow Machine Learning Model
